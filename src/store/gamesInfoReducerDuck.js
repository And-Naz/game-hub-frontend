...
// Actions
const SET_GAME_INFO = 'authReducer/SET_GAME_INFO'; 
...
const defaultState = {
	gamesInfo: [
        ...
        },
        {
            ...
            country: {
                name: 'USA',
                url: 'filter/country/USA/'
            },
            created: {
                name: 'LittleBigSnake',
                url: 'filter/created/LittleBigSnake/'
            },
            price: '0',
            saleFrom: '0',
            rating: "37",
...
export default function authReducer(state = defaultState, { type, payload } = {}) {
	switch (type) {
		case SET_GAME_INFO: {
			return { ...state, gamesInfo: payload }
		}
...
// Action Creators
export const setAuth = Synchronous(SET_GAME_INFO)